...
class GeometricMatching(nn.Module):
    def __init__(self):
        ...
        self.regression = FeatureRegression(input_nc=192, output_dim=50, use_cuda=True)
...
class TryOn(nn.Module):
    def __init__(self):
        ...
        self.theta = GeometricMatching()
        self.ContentEncoder = ContentEncoder(3,4,3,64,'in','relu','reflect')
...
a = torch.randn((4,1,256,192))
b = torch.randn((4,3,256,192))
gmm = GeometricMatching()
gmm(a,b)
